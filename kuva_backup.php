                                        ...
                                        while ($row_comment_print = mysql_fetch_array($select_comment_print)) {
                                            echo '<br><br><div class="comment"><blockquote>';
                                                ...
                                                if ($_COOKIE[ID_my_site] == $row_comment_print["kommentin_lisannyt"]) {
                                                    echo '<small><form method="POST" action="deletecomment.php"><p><a onclick="form.submit();" href="#">Poista</a></p><form></small>';
                                                } else {

                                                }
                                                    echo '<small>Lisännyt: '.$row_comment_print["kommentin_lisannyt"].'</small>';
                                                }
                                            echo '</div><br></blockquote>';
                                        }
                                    }
