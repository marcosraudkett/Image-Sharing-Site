...
//kun turvallisten tapojen tekemiseen menisi enemmän aikaa...
    			...
    			<div class="row margin-bottom-40">    			
    				...
    				<br><br>
    					<p class="lead text-center" data-selector="p" style="outline: none;">
                            ...
                            <a href="before.php">Edellinen</a> KUVA <a href="next.php">Seuraava</a></p>
...
//tässä voidaan hakea se kuva ja kaikki sen tiedot jotka haettiin scriptin alussa.
    ...
    $data = mysql_fetch_assoc($select_likes_total);
        ...
        //share nappi: 
        echo '<form><button class="btn btn-default btn-embossed btn-lg btn-wide" type="button" id="submit_button"  data-toggle="modal" data-target="#share" value="Jaa Kuvaa" />Jaa Kuvaa</button></form>';
                                        ...
                                        while ($row_comment_print = mysql_fetch_array($select_comment_print)) {
                                            echo '<br><br><div style="border-style: solid; border-width: 1px;width:250px;" class="comment">';
                                                ...
                                                if ($row_comment_print["kommentin_lisannyt"] == '') {
                                                    echo '<p style="margin-bottom:10px;">'.$row_comment_print["kommentin_sisalto"].'</p>';
                                                ...
                                                if ($_COOKIE[ID_my_site] == $row_comment_print["kommentin_lisannyt"]) {
                                                    echo '<form method="POST" action="deletecomment.php"><h4 style="text-align:right;font-size:14px;margin-right:5px;margin-top:-5px;margin-bottom:-30px;"><a onclick="form.submit();" href="#">Poista</a></h4><form>';
                                                } else {

                                                }
                                                    echo '<h4 style="text-align:left;font-size:14px;margin-right:5px;margin-top:15px;margin-bottom:5px;">Lisännyt: '.$row_comment_print["kommentin_lisannyt"].'</h4>';
                                                }
                                            echo '</div><br>';
                                        }
                                    }
